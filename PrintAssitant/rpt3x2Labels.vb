...
Public Class rpt3x2Labels
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PrintAssitant.rpt3x2Labels.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrpt3x2Labels
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt3x2Labels = New rpt3x2Labels()
        rpt.Site = Me.Site
        Return rpt
    End Function
